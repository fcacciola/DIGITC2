...
{
  public class EnvelopeB : WaveFilter
  {
    class Iteration
    {
    ...
    {
      EnvelopeFollower envelopeFollower = new EnvelopeFollower(X.SamplingRate, aIteration.AttackTime, aIteration.ReleaseTime);
      ...
      var lESRep = new DiscreteSignal(X.SamplingRate, lNewSamples);
